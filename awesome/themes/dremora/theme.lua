...
theme.taglist_font                              = "Icons 21"
theme.fg_normal                                 = "#747474"
theme.fg_focus                                  = "#DDDCFF"
theme.bg_normal                                 = "#000"--"#121212"
theme.bg_focus                                  = "#000"--"#121212"
...
theme.taglist_bg_focus                          = "#000"--121212"
...
function theme.at_screen_connect(s)
    ...
    local f = io.popen("sh -c \"find ~/.config/awesome/backgrounds/ -name '*.jpg' | shuf -n 1 | xargs echo -n\"")
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "bottom", screen = s, height = 28, rg = theme.bg_normal, fg = theme.fg_normal })
